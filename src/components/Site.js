...
function Site() {
  return (
    <>
      <div id="about" className="h-screen flex flex-wrap justify-center text-gray-300 text-center text-white lg:w-3/4 
      lg:mt-32 mt-14 mx-8 tracking-widest leading-9" data-aos="fade-up">
        <div className="">
